...
XQC_EXPORT_PUBLIC_API XQC_EXTERN const xqc_scheduler_callback_t xqc_macrtt_rap_scheduler_cb;
XQC_EXPORT_PUBLIC_API XQC_EXTERN const xqc_scheduler_callback_t xqc_musher_scheduler_cb;
XQC_EXPORT_PUBLIC_API XQC_EXTERN const xqc_scheduler_callback_t xqc_mac_aware_scheduler_cb;
XQC_EXPORT_PUBLIC_API XQC_EXTERN const xqc_scheduler_callback_t xqc_blest_scheduler_cb;
XQC_EXPORT_PUBLIC_API XQC_EXTERN const xqc_scheduler_callback_t xquic_scheduler_xlink;
